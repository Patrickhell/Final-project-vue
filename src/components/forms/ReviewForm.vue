<template>
    <section class="w-full">
        ...
        <form @submit.prevent="sendReviewForm" @reset.prevent="clearReviewForm">
            <div v-if="reviewSent" class=" success-message p-4 mb-4 mt-4 text-sm text-gray-900 rounded-lg bg-bd_secondary-color dark:bg-bd_secondary-color dark:text-green-400" role="alert " >
                <span class="font-medium"></span> Recensione inviata con successo!!
            </div>
            ...
            <div class="flex mt-4 gap-6">
                ...
                <div class="w-2/3">
                    ...
                    <input type="text" v-model="reviewTitle" required id="reviewTitle"
                        class="bg-bd_secondary-color border-2 border-bd_primary-color text-gray-900 placeholder-gray-900 text-sm rounded-lg focus:ring-bd_primary-color focus:border-bd_primary-color block w-full p-2.5 placeholder:text-gray-500">
                </div>
            ...
            <div class="mt-4">
                ...
                <textarea type="text" v-model="reviewContent" rows="5" required id="reviewContent"
