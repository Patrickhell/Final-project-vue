        ...
        <div>
          ...
          <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center border-b border-black pb-6 pt-24">
              <Pagination :current-page="apiDetails.currentPage" :total-pages="apiDetails.lastPage" :next-page="nextPage" :prev-page="prevPage" @goto-page="loadPage" />
              <div class="flex items-center">
            ...
            <div class="py-6">
              <Pagination :current-page="apiDetails.currentPage" :total-pages="apiDetails.lastPage" :next-page="nextPage" :prev-page="prevPage" />
            </div>
          </main>
        </div>
</template>
