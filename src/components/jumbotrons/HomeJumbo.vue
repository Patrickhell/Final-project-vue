        ...
        <div class="py-16 px-6 mx-auto max-w-screen-2xl text-center lg:py-48 z-10 relative">
            ...
            <form class="w-full max-w-md mx-auto">
                ...
                <div class="relative">
                    ...
                    <select v-model="selectedSpecialty" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
export default {
    ...
    data() {
        return {
            selectedSpecialty: null,  // This will hold the selected specialty id
        };
    },
    methods: {
        handleSearch(event) {
