        ...
        <div class="px-6 mx-auto max-w-screen-2xl text-center z-10 relative">
            ...
            <div class="w-full max-w-md mx-auto">
                <div class="relative">
                    ...
                    <select v-model="selectedSpecialty" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-bd_primary-color rounded-xl bg-white focus:ring-bd_primary-color focus:border-bd_primary-color">
