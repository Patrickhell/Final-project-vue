<template>
    ...
    <section class="mt-20 px-6 pt-20 pb-12" id="servicePlans">
        <div class="mx-auto max-w-screen-2xl text-center flex flex-col 2xl:flex-row 2xl:text-start 2xl:h-[36rem]">
            <div class="bd_text-col lg:mr-20">
                <span class="py-4 font-normal uppercase text-xl bd_introductive-title">
                    Aumenta la tua visibilità...
                </span>
                <h3
                    class="mb-8 px-6 lg:px-32 xl:p-0 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-5xl dark:text-white">
                ...
                <a href=""
                    class="px-6 py-3.5 text-base focus:ring-4 focus:outline-none focus:ring-bd_btn-shadow rounded-full text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 bd_btn">
                    Scopri altri piani
                </a>
            </div>
            <div
                class="mt-12 flex flex-col items-center gap-6 lg:flex-row lg:justify-center 2xl:m-0 lg:items-start db-sponsor-plans">
                <SponsorshipCard :planName="plan.planName" :price="plan.price" :hours="plan.hours" :features="plan.features"
                    v-for="(plan, index) in sponsorshipPlans" :key="index"
                    :class="[alignClasses(index), generateCardClass(index)]" />
            </div>
        </div>
    </section>
</template>
...
export default {
    ...
    data() {
        return {
            sponsorshipPlans: [
                {
                    planName: 'Piano Giornaliero',
                    price: '2,99',
                    hours: 24,
                    features: [
                        'Durata: 24 ore/1 giorno',
                    ],
                },
                {
                    planName: 'Piano Breve',
                    price: '5,99',
                    hours: 72,
                    features: [
                ...
                {
                    planName: 'Piano Settimanale',
                    price: '9,99',
                    hours: 144,
                    features: [
                        'Durata: 144 ore/6 giorni',
                    ],
                },
            ],
        };
